...
const InfiniteMovingCards = ({ speed = 30 }) => {
  ...
  return (
    <div className="relative w-full overflow-hidden py-8 bg-page text-page">
      ...
      <motion.div className="flex gap-6" animate={controls} ref={containerRef}>
        {[...reviews, ...reviews].map((review, index) => (
          <div
            key={index}
            className="flex-shrink-0 rounded-2xl shadow-lg border border-gray-300 dark:border-neutral-700 backdrop-blur-md px-6 py-4 bg-white dark:bg-neutral-800 text-black dark:text-white min-w-[250px] max-w-xs sm:min-w-[280px] sm:max-w-sm md:min-w-[320px] md:max-w-md lg:min-w-[380px] lg:max-w-lg"
          >
